import {DetailFormatTypes, EventActions} from "../types";
    ...
    data: [
        {
            ...
            actions: [
                {
                    ...
                    date: '',
                    action_taken: false,
                    action_id: EventActions.NoActionNeeded,
                },
                {
                    comment: '',
                    task_id: '',
                    ...
                    date: '',
                    action_taken: false,
                    action_id: EventActions.TakeAction,
                },
            ],
            extras: {
                new: false,
            ...
            details: [
                {
                    format: DetailFormatTypes.Date,
                    value: '2020-04-29T15:03:44.871Z',
                    title: 'Tarih',
                },
                {
                    format: DetailFormatTypes.IncidentType,
                    value: 'Breakdown',
                    title: 'Tip',
                },
                {
                    format: DetailFormatTypes.String,
                ...
                {
                    format: DetailFormatTypes.Vehicle,
                    value: '06 ADN 61',
                    title: 'Araç',
                },
                {
